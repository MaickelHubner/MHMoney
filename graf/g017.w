...
DEFINE FRAME DEFAULT-FRAME
     ...
     "%" VIEW-AS TEXT
          SIZE 2 BY .54 AT ROW 5.13 COL 35.57
...
END.
ELSE MESSAGE "g017.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  ...
  ENABLE btCancel IMAGE-5 btOK IMAGE-6 RECT-10 data-ini data-fim tipo moeda 
         agrupa 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
ASSIGN tt-graf-par.dado-label     = "Favorecido"
...
FOR EACH tt-comp:
    ...
    IF deAgrup > agrupa THEN DO:
        ...
        CREATE tt-graf.
        ASSIGN tt-graf.dado = favorecido.ds-favorecido
               tt-graf.seq  = iTemp
               iTemp = iTemp + 1
