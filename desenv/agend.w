...
&GLOBAL-DEFINE FrameFields  agenda.cd-conta agenda.simulado ~
                            ...
                            agenda.usuar-resp agenda.fav-agrup ~
                            conta favor ds-fav-agrup categoria sub conta-tran
...
&Scoped-Define ENABLED-OBJECTS ds-fav-agrup btMov btProg btVal btGoTo ~
btFirst btLast btNext btPrev btAdd btDel btExit btUpdate btZoom RECT-4 ~
RECT-5 RECT-7 RECT-8 
...
&Scoped-Define DISPLAYED-OBJECTS ds-fav-agrup conta favor categoria sub ~
conta-tran 
...
DEFINE VARIABLE ds-fav-agrup AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 33 BY .79 NO-UNDO.
...
DEFINE FRAME DEFAULT-FRAME
     ds-fav-agrup AT ROW 11.25 COL 33.29 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     agenda.usuar-resp AT ROW 16 COL 28 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEMS "Item 1" 
          DROP-DOWN-LIST
          SIZE 19 BY 1
     btMov AT ROW 17.5 COL 14.14
     agenda.cd-agenda AT ROW 4.5 COL 28 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4 BY .79
     btProg AT ROW 17.5 COL 8.14
     agenda.simulado AT ROW 4.5 COL 40
          VIEW-AS TOGGLE-BOX
          SIZE 10 BY .83
     btVal AT ROW 17.5 COL 2
     ...
     agenda.conta-transf AT ROW 13 COL 28 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4 BY .79
     conta-tran AT ROW 13 COL 32.29 COLON-ALIGNED NO-LABEL
     btAdd AT ROW 1.5 COL 30
     agenda.dt-ini AT ROW 14 COL 28 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .79
     btCancel AT ROW 17.5 COL 81.14
     agenda.dt-fim AT ROW 15 COL 28 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .79
     agenda.dt-ultimo-pag AT ROW 14 COL 56.29 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .79
     agenda.prox-data-pag AT ROW 15 COL 56.29 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10 BY .79
     btDel AT ROW 1.5 COL 42.29
     btExit AT ROW 1.5 COL 80
     btOK AT ROW 17.5 COL 75
     btUpdate AT ROW 1.5 COL 36.14
     btZoom AT ROW 1.5 COL 54.57
     agenda.fav-agrup AT ROW 11.25 COL 28 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 5 BY .79
     RECT-4 AT ROW 4 COL 2
     RECT-5 AT ROW 1.25 COL 2
     RECT-7 AT ROW 8 COL 2
     RECT-8 AT ROW 12.75 COL 2
...
&Scoped-define SELF-NAME agenda.fav-agrup
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL agenda.fav-agrup C-Win
ON ENTRY OF agenda.fav-agrup IN FRAME DEFAULT-FRAME /* Favorecido Agrup. */
DO:
    {func\set_entry.i}  
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL agenda.fav-agrup C-Win
ON LEAVE OF agenda.fav-agrup IN FRAME DEFAULT-FRAME /* Favorecido Agrup. */
DO:
    {func\leave.i &Tabela="favorecido"
                  &Campo="cd-favorecido"
                  &CampoProc = "ds-favorecido"
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL agenda.fav-agrup C-Win
ON MOUSE-SELECT-DBLCLICK OF agenda.fav-agrup IN FRAME DEFAULT-FRAME /* Favorecido Agrup. */
OR F5 OF {&Table}.cd-favorecido DO:
    {func\zoom.i &Tabela="favorecido"
                 &Campo1="cd-favorecido"
                 &Tela1="agenda.fav-agrup"
                 &Campo2="ds-favorecido"
                 &Tela2="ds-fav-agrup"}
END.
...
APPLY "LEAVE" TO agenda.fav-agrup IN FRAME {&FRAME-NAME}.
...
------------------------------------------------------------------------------*/
  DISPLAY ds-fav-agrup conta favor categoria sub conta-tran 
  ...
  IF AVAILABLE agenda THEN 
    DISPLAY agenda.usuar-resp agenda.cd-agenda agenda.simulado agenda.calc-cpmf 
          ...
          agenda.fav-agrup 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE ds-fav-agrup agenda.usuar-resp btMov agenda.cd-agenda btProg 
         agenda.simulado btVal agenda.calc-cpmf agenda.cd-conta btGoTo btFirst 
         agenda.id-tipo agenda.cd-favorecido agenda.cod-categoria btLast btNext 
         btPrev agenda.cd-sub agenda.conta-transf btAdd agenda.dt-ini 
         agenda.dt-fim agenda.dt-ultimo-pag agenda.prox-data-pag btDel btExit 
         btUpdate btZoom RECT-4 RECT-5 RECT-7 RECT-8 agenda.fav-agrup 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
