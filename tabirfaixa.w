...
&GLOBAL-DEFINE Filho         tabela-ir-faixa
&GLOBAL-DEFINE LabelFilho    Faixas da Tabela de IR
&GLOBAL-DEFINE ParentFields  tabela-ir.cd-tabela tabela-ir.ds-tabela
&GLOBAL-DEFINE KeyFields     tabela-ir.cd-tabela
&GLOBAL-DEFINE CamposFilho   tabela-ir-faixa.val-ini ~
                             tabela-ir-faixa.val-end ~
...
&Scoped-define INTERNAL-TABLES {&Filho} tabela-ir
...
&Scoped-define FIELDS-IN-QUERY-DEFAULT-FRAME tabela-ir.cd-tabela ~
tabela-ir.ds-tabela 
&Scoped-define ENABLED-FIELDS-IN-QUERY-DEFAULT-FRAME tabela-ir.cd-tabela ~
tabela-ir.ds-tabela 
&Scoped-define ENABLED-TABLES-IN-QUERY-DEFAULT-FRAME tabela-ir
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-DEFAULT-FRAME tabela-ir
&Scoped-define OPEN-BROWSERS-IN-QUERY-DEFAULT-FRAME ~
    ~{&OPEN-QUERY-br-page1}
&Scoped-define QUERY-STRING-DEFAULT-FRAME FOR EACH tabela-ir SHARE-LOCK
&Scoped-define OPEN-QUERY-DEFAULT-FRAME OPEN QUERY DEFAULT-FRAME FOR EACH tabela-ir SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-DEFAULT-FRAME tabela-ir
&Scoped-define FIRST-TABLE-IN-QUERY-DEFAULT-FRAME tabela-ir
...
DEFINE FRAME DEFAULT-FRAME
     ...
     tabela-ir.cd-tabela AT ROW 4.5 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY .79
     tabela-ir.ds-tabela AT ROW 4.5 COL 26.29 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 49 BY .79
...
IF NOT AVAIL {&Table} THEN DO:
    ...
    ASSIGN tabela-ir.cd-tabela:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ?
           tabela-ir.ds-tabela:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "".
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE tabela-ir THEN 
    DISPLAY tabela-ir.cd-tabela tabela-ir.ds-tabela 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE br-page1 btAdd-page1 btDel-page1 btExit btFirst btLast btNext btPrev 
         btUpdate-page1 tabela-ir.cd-tabela tabela-ir.ds-tabela btGoTo btZoom 
         RECT-5 RECT-6 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
