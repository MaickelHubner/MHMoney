...
&GLOBAL-DEFINE Filho         proj-periodo
&GLOBAL-DEFINE LabelFilho    Per°odos do Projeto
&GLOBAL-DEFINE ParentFields  projeto.cd-projeto projeto.ds-projeto
&GLOBAL-DEFINE KeyFields     projeto.cd-projeto
&GLOBAL-DEFINE CamposFilho   proj-periodo.ds-periodo ~
                             proj-periodo.dt-ini ~
                             proj-periodo.dt-end
...
&Scoped-define INTERNAL-TABLES {&Filho} projeto
...
&Scoped-define FIELDS-IN-QUERY-DEFAULT-FRAME projeto.cd-projeto ~
projeto.ds-projeto 
&Scoped-define ENABLED-FIELDS-IN-QUERY-DEFAULT-FRAME projeto.cd-projeto ~
projeto.ds-projeto 
&Scoped-define ENABLED-TABLES-IN-QUERY-DEFAULT-FRAME projeto
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-DEFAULT-FRAME projeto
&Scoped-define OPEN-BROWSERS-IN-QUERY-DEFAULT-FRAME ~
    ~{&OPEN-QUERY-br-page1}
&Scoped-define QUERY-STRING-DEFAULT-FRAME FOR EACH projeto SHARE-LOCK
&Scoped-define OPEN-QUERY-DEFAULT-FRAME OPEN QUERY DEFAULT-FRAME FOR EACH projeto SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-DEFAULT-FRAME projeto
&Scoped-define FIRST-TABLE-IN-QUERY-DEFAULT-FRAME projeto
...
DEFINE FRAME DEFAULT-FRAME
     ...
     projeto.cd-projeto AT ROW 4.5 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY .79
     projeto.ds-projeto AT ROW 4.5 COL 26.29 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 49 BY .79
...
IF NOT AVAIL {&Table} THEN DO:
    ...
    ASSIGN projeto.cd-projeto:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ?
           projeto.ds-projeto:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "".
...
------------------------------------------------------------------------------*/
  ...
  ENABLE br-page1 btAdd-page1 btDel-page1 btExit btFirst btLast btNext btPrev 
         btUpdate-page1 projeto.cd-projeto projeto.ds-projeto btGoTo btZoom 
         RECT-5 RECT-6 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
