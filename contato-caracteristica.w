...
&GLOBAL-DEFINE Filho         contato-caracteristica
&GLOBAL-DEFINE LabelFilho    Caracter°sticas
&GLOBAL-DEFINE ParentFields  contato.cd-favorecido c-ds-favorecido contato.cd-contato contato.nome
&GLOBAL-DEFINE KeyFields     contato.cd-favorecido contato.cd-contato 
&GLOBAL-DEFINE CamposFilho   contato-caracteristica.sequencia ~
                             fnCd-caracteristica(contato-caracteristica.cd-caracteristica) @ cCd-caracteristica ~
                             contato-caracteristica.descricao
...
&Scoped-define INTERNAL-TABLES {&Filho} contato
...
&Scoped-define FIELDS-IN-QUERY-DEFAULT-FRAME contato.cd-contato ~
contato.nome contato.cd-favorecido 
&Scoped-define ENABLED-FIELDS-IN-QUERY-DEFAULT-FRAME contato.cd-contato ~
contato.nome contato.cd-favorecido 
&Scoped-define ENABLED-TABLES-IN-QUERY-DEFAULT-FRAME contato
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-DEFAULT-FRAME contato
&Scoped-define OPEN-BROWSERS-IN-QUERY-DEFAULT-FRAME ~
    ~{&OPEN-QUERY-br-page1}
&Scoped-define QUERY-STRING-DEFAULT-FRAME FOR EACH contato SHARE-LOCK
&Scoped-define OPEN-QUERY-DEFAULT-FRAME OPEN QUERY DEFAULT-FRAME FOR EACH contato SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-DEFAULT-FRAME contato
&Scoped-define FIRST-TABLE-IN-QUERY-DEFAULT-FRAME contato


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS contato.cd-contato contato.nome ~
contato.cd-favorecido 
&Scoped-define ENABLED-TABLES contato
...
&Scoped-Define DISPLAYED-FIELDS contato.cd-contato contato.nome ~
contato.cd-favorecido 
&Scoped-define DISPLAYED-TABLES contato
&Scoped-define FIRST-DISPLAYED-TABLE contato
&Scoped-Define DISPLAYED-OBJECTS c-ds-favorecido 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 93 BY 8.21
         FONT 7
         TITLE "".
...
DEFINE FRAME DEFAULT-FRAME
     br-page1 AT ROW 6.5 COL 2
     c-ds-favorecido AT ROW 4 COL 26 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     ...
     contato.cd-contato AT ROW 5 COL 20 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 9 BY .88
     contato.nome AT ROW 5 COL 29 COLON-ALIGNED NO-LABEL WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 44 BY .88
     contato.cd-favorecido AT ROW 4 COL 20 COLON-ALIGNED NO-LABEL WIDGET-ID 10
          VIEW-AS FILL-IN 
          SIZE 6 BY .88
     "Contato:" VIEW-AS TEXT
          SIZE 5.86 BY .54 AT ROW 5.17 COL 16 WIDGET-ID 14
     "Cliente:" VIEW-AS TEXT
          SIZE 5 BY .54 AT ROW 4.21 COL 16.57 WIDGET-ID 92
     RECT-5 AT ROW 3.63 COL 2
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  {version.i contato-caracteristica}
  RUN enable_UI.
  RUN initialize.
...
IF NOT AVAIL {&Table} THEN
    ASSIGN contato.cd-contato:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ?
           c-ds-favorecido:SCREEN-VALUE IN FRAME {&FRAME-NAME}    = ""
           contato.cd-contato:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ?
           contato.nome:SCREEN-VALUE IN FRAME {&FRAME-NAME}       = "".

FIND FIRST favorecido NO-LOCK
     WHERE favorecido.cd-favorecido = INPUT FRAME {&FRAME-NAME} contato.cd-favorecido NO-ERROR.
...
ASSIGN gCd-contato = INPUT FRAME {&FRAME-NAME} contato.cd-contato.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-ds-favorecido 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  IF AVAILABLE contato THEN 
    DISPLAY contato.cd-contato contato.nome contato.cd-favorecido 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE br-page1 btAdd-page1 btDel-page1 btExit btFirst btLast btNext btPrev 
         btUpdate-page1 btGoTo btZoom contato.cd-contato contato.nome 
         contato.cd-favorecido RECT-5 RECT-6 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
