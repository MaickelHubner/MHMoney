...
END.
ELSE MESSAGE "r025.wrx":U SKIP(1)
...
DEFINE VARIABLE vl-total AS DECIMAL FORMAT "->>>>,>>9.99" NO-UNDO EXTENT 13.
DEFINE VARIABLE vl-rec AS DECIMAL FORMAT "->>>>,>>9.99" NO-UNDO EXTENT 13.
DEFINE VARIABLE vl-desp AS DECIMAL FORMAT "->>>>,>>9.99" NO-UNDO EXTENT 13.
DEFINE VARIABLE vl-varc AS DECIMAL FORMAT "->>>>,>>9.99" NO-UNDO EXTENT 13.
...
ASSIGN cTemp = "Ano: " + STRING(ano,"9999").
{func\relat\capitulo.i cTemp 750}

{func\relat\titulo.i &Coluna1='"Mensal"'
                     &Tamanho1=150
                     &Coluna2='"Receita"'
                     &Tamanho2=120
                     &Coluna3='"Despesa"'
...
REPEAT iMes = 1 TO 12:
    ...
    RUN recXdesp.p (INPUT fnUltimoDia(iMes, ano),
                    INPUT moeda, OUTPUT vl-rec[iMes], OUTPUT vl-desp[iMes]).
    RUN var_camb.p (INPUT fnUltimoDia(iMes, ano),
                    INPUT moeda, OUTPUT vl-varc[iMes]).
    RUN renddesp.p (INPUT fnUltimoDia(iMes, ano),
    ...
    {func\relat\linha.i &Coluna1=cMes
                        ...
                        &Coluna2=vl-rec[iMes]
                        &Align2="right"
                        &Coluna3=vl-desp[iMes]
                        &Align3="right"
                        &Coluna4=vl-varc[iMes]
                        &Align4="right"
                        &Coluna5=vl-total[iMes]
                        &Align5="right"}
END.
...
{func\relat\titulo.i &Coluna1='"Trimestral"'
                     &Tamanho1=150
                     &Coluna2='"Receita"'
                     &Tamanho2=120
                     &Coluna3='"Despesa"'
...
REPEAT iMes = 1 TO 12:
    ...
    ASSIGN vl-rec[13] = vl-rec[13] + vl-rec[iMes]
           vl-desp[13] = vl-desp[13] + vl-desp[iMes]
           vl-varc[13] = vl-varc[13] + vl-varc[iMes]
           vl-total[13] = vl-total[13] + vl-total[iMes]
           iTemp = iTemp + 1.
    IF iTemp = 3 THEN DO:
        CASE iTrim:
            WHEN 1 THEN
                ASSIGN cMes = "Primeiro".
            WHEN 2 THEN
                ASSIGN cMes = "Segundo".
            WHEN 3 THEN
                ASSIGN cMes = "Terceiro".
            WHEN 4 THEN
                ASSIGN cMes = "Quarto".
        END CASE.
        {func\relat\linha.i &Coluna1=cMes
                            ...
                            &Coluna5=vl-total[13]
                            &Align5="right"
                            &Coluna6="(vl-total[13] / 3)"
                            &Align6="right"}
        ASSIGN iTrim = iTrim + 1
               iTemp = 0
               vl-rec[13] = 0
               vl-desp[13] = 0
               vl-varc[13] = 0
...
{func\relat\titulo.i &Coluna1='"Semestral"'
                     &Tamanho1=150
                     &Coluna2='"Receita"'
                     &Tamanho2=120
                     &Coluna3='"Despesa"'
...
{func\relat\total.i &Coluna1='"Anual"'
                    &Align1="left"
                    &Coluna2=vl-rec[13]
                    &Align2="right"
                    &Coluna3=vl-desp[13]
