...
&GLOBAL-DEFINE FrameFields  data-ini data-fim moeda tipo cat
...
data-ini data-fim tipo cat moeda 
&Scoped-Define DISPLAYED-OBJECTS data-ini data-fim tipo cat moeda 
...
END.
ELSE MESSAGE "r019.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  RUN control_load.
  DISPLAY data-ini data-fim tipo cat moeda 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE btCancel IMAGE-5 btOK IMAGE-6 RECT-10 data-ini data-fim tipo cat moeda 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
IF INPUT FRAME {&FRAME-NAME} tipo = 1 THEN
    ASSIGN cTit = TRIM(ENTRY(1,CURRENT-WINDOW:TITLE,"-")) + "-Categorias de Receita".
ELSE
    ASSIGN cTit = TRIM(ENTRY(1,CURRENT-WINDOW:TITLE,"-")) + "-Categorias de Despesa".
