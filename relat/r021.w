...
&GLOBAL-DEFINE FrameFields  data-ini data-fim moeda iConta des-conta
...
&Scoped-Define ENABLED-OBJECTS btCancel IMAGE-5 btOK IMAGE-6 RECT-10 iConta ~
des-conta data-ini data-fim moeda 
&Scoped-Define DISPLAYED-OBJECTS iConta des-conta data-ini data-fim moeda 
...
DEFINE FRAME DEFAULT-FRAME
     ...
     iConta AT ROW 1.75 COL 15 COLON-ALIGNED
     des-conta AT ROW 1.75 COL 19.29 COLON-ALIGNED NO-LABEL
     data-ini AT ROW 2.75 COL 15 COLON-ALIGNED
     data-fim AT ROW 2.75 COL 33 COLON-ALIGNED NO-LABEL
     moeda AT ROW 3.75 COL 15 COLON-ALIGNED
     IMAGE-5 AT ROW 2.33 COL 26
     IMAGE-6 AT ROW 2.33 COL 30.43
...
END.
ELSE MESSAGE "r021.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  RUN control_load.
  DISPLAY iConta des-conta data-ini data-fim moeda 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE btCancel IMAGE-5 btOK IMAGE-6 RECT-10 iConta des-conta data-ini 
         data-fim moeda 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
/* Output padr∆o */
ASSIGN iMax = INT((data-fim - data-ini) / 30) + 2.
...
{func\relat\capitulo.i cTemp 240}
...
FOR EACH mov-conta OF conta NO-LOCK
    ...
    ASSIGN deValor = fnCotacao(mov-conta.de-valor,mov-conta.cd-moeda,moeda,mov-conta.dt-mov).
    ASSIGN deTotal = deTotal + deValor
           iCont = iCont + 1.

    {func\relat\linha.i &Coluna1=mov-conta.dt-mov
                        &Align1="left"
                        &Coluna2=deValor
                        &Align2="right"}
...
FIND FIRST conta NO-LOCK
    WHERE conta.id-tipo = 3
    AND   NOT conta.dinheiro
    AND   NOT conta.id-encerrada.

ASSIGN data-ini = TODAY - 365
       data-fim = TODAY
