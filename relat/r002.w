...
END.
ELSE MESSAGE "r002.wrx":U SKIP(1)
...
ASSIGN cTemp = "Mˆs:   " + fnMes(mes) + "/" + STRING(ano,"9999") + "<br>" +
...
FOR EACH mov-conta OF conta NO-LOCK
    ...
    BY dt-compensacao:
        ...
        {func\relat\linha.i &Coluna1=mov-conta.dt-compensacao
                            ...
                            &Align2="left"
                            &Coluna3=fnCotacao(mov-conta.de-valor,mov-conta.cd-moeda,moeda,mov-conta.dt-compensacao)
                            &Align3="right"}
        ASSIGN deValor = deValor + fnCotacao(mov-conta.de-valor,mov-conta.cd-moeda,moeda,mov-conta.dt-compensacao).
