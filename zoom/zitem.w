...
&GLOBAL-DEFINE CamposBrowse  cd-item ~
                             ds-item ~
                             unidade ~
                             fnCod-categoria(item.cod-categoria) @ cCod-categoria ~
                             fnCd-sub(item.cd-sub,item.cod-categoria) @ cCd-sub ~
                             dt-ult-compra

&GLOBAL-DEFINE CamposFiltro  cd-item ~
                             ds-item
