...
&GLOBAL-DEFINE CamposBrowse  cd-tabela-preco ~
                             ds-tabela-preco ~
                             fnCd-favorecido(tabela-preco.cd-favorecido) @ cCd-favorecido ~
                             dt-val-ini ~
                             dt-val-fim

&GLOBAL-DEFINE CamposFiltro  cd-tabela-preco ~
                             ds-tabela-preco ~
                             cd-favorecido
...
DO: 
    {func\zoom\bt_implantar.i &Programa="tabpreco"}
END.
