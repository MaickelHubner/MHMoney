...
&GLOBAL-DEFINE CamposBrowse  cod-categoria ~
                             ds-categoria ~
                             fnId-tipo(categoria.id-tipo) @ cId-tipo
...
ON END-ERROR OF C-Win /* Zoom de categorias */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Zoom de categorias */
DO:
...
DO: 
    {func\zoom\bt_implantar.i &Programa="cat"}
END.
...
------------------------------------------------------------------------------*/
    ...
    CASE iCod:
        WHEN 1 THEN RETURN "Receita".
        WHEN 2 THEN RETURN "Despesa".
    END CASE.
