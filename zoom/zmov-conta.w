...
&GLOBAL-DEFINE CamposBrowse  mov-conta.cd-conta ~
                             cd-sequencia ~
                             dt-mov ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fnDsFavorecido C-Win 
FUNCTION fnDsFavorecido RETURNS CHARACTER
  ( i-cd-favorecido AS INTEGER )  FORWARD.
...
DO: 
    {func\zoom\bt_implantar.i &Programa="mov"}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fnDsFavorecido C-Win 
FUNCTION fnDsFavorecido RETURNS CHARACTER
  ( i-cd-favorecido AS INTEGER ) :
...
------------------------------------------------------------------------------*/
  ...
  FIND FIRST favorecido NO-LOCK
       WHERE favorecido.cd-favorecido = i-cd-favorecido NO-ERROR.
