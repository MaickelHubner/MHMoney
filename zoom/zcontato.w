...
&GLOBAL-DEFINE CamposBrowse  cd-contato ~
                             nome ~
                             cargo ~
                             telefone ~
                             data-nasc ~
                             ativo
&GLOBAL-DEFINE CamposFiltro  cd-contato ~
                             nome ~
                             cd-favorecido ~
                             ativo
...
&Scoped-define FIELDS-IN-QUERY-brZoom /* {&CamposBrowse}*/ contato.cd-contato contato.nome contato.cargo contato.telefone contato.data-nasc contato.ativo   
