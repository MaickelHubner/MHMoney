...
&GLOBAL-DEFINE CamposBrowse  cd-favorecido ~
                             ds-favorecido ~
                             cidade ~
                             estado ~
                             telefone
&GLOBAL-DEFINE CamposFiltro  cd-favorecido ~
                             ds-favorecido ~
                             cidade
...
&Scoped-define FIELDS-IN-QUERY-brZoom /* {&CamposBrowse}*/ favorecido.cd-favorecido ds-favorecido favorecido.cidade estado telefone   
&Scoped-define ENABLED-FIELDS-IN-QUERY-brZoom   
&Scoped-define SELF-NAME brZoom
&Scoped-define QUERY-STRING-brZoom FOR EACH {&Table} NO-LOCK                            WHERE {&Table}.tipo = 1 /* cliente */                               OR {&Table}.tipo = 3 /* ambos */ INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-brZoom OPEN QUERY {&SELF-NAME} FOR EACH {&Table} NO-LOCK                            WHERE {&Table}.tipo = 1 /* cliente */                               OR {&Table}.tipo = 3 /* ambos */ INDEXED-REPOSITION.
...
/* Query rebuild information for BROWSE brZoom
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH {&Table} NO-LOCK
                           WHERE {&Table}.tipo = 1 /* cliente */
                              OR {&Table}.tipo = 3 /* ambos */ INDEXED-REPOSITION.
     _END_FREEFORM
...
ON END-ERROR OF C-Win /* Zoom de favorecidos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Zoom de favorecidos */
DO:
