...
&GLOBAL-DEFINE CamposBrowse  nr-pedido ~
                             nom-projeto ~
                             fnCd-favorecido(pedido.cd-favorecido) @ cCd-favorecido ~
                             dt-pedido ~
                             situacao ~
                             val-total

&GLOBAL-DEFINE CamposFiltro  nr-pedido ~
                             dt-pedido ~
                             cd-favorecido ~
                             situacao
...
DO: 
    {func\zoom\bt_implantar.i &Programa="pedido"}
END.
