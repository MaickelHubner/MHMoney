...
&GLOBAL-DEFINE CamposBrowse  nome ~
                             senha ~
                             administrador
&GLOBAL-DEFINE CamposFiltro  nome ~
                             senha
...
ON END-ERROR OF C-Win /* Zoom de usuarios */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Zoom de usuarios */
DO:
