...
&GLOBAL-DEFINE CamposBrowse  moeda.cd-moeda ~
                             ds-moeda ~
                             sigla
&GLOBAL-DEFINE CamposFiltro  cd-moeda ~
                             ds-moeda
...
ON END-ERROR OF C-Win /* Zoom de moedas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Zoom de moedas */
DO:
