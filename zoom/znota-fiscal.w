...
{campos\cod-categoria.i}
{campos\cd-sub.i}

/* Pr‚-processadores */
&GLOBAL-DEFINE Table         nota-fiscal
&GLOBAL-DEFINE CamposBrowse  nota-fiscal.nr-controle ~
                             fnCd-favorecido(nota-fiscal.cd-favorecido) @ cCd-favorecido ~
                             nota-fiscal.nr-nota ~
                             nota-fiscal.val-total ~
                             nota-fiscal.val-liquido ~
                             fnCod-categoria(nota-fiscal.cod-categoria) @ cCod-categoria ~
                             fnCod-categoria(nota-fiscal.cd-sub) @ cCd-sub 
                             
                             

&GLOBAL-DEFINE CamposFiltro  nr-controle ~
                             nr-nota ~
                             cd-favorecido
...
&Scoped-define FIELDS-IN-QUERY-brZoom /* {&CamposBrowse} */ nota-fiscal.nr-controle fnCd-favorecido(nota-fiscal.cd-favorecido) @ cCd-favorecido nota-fiscal.nr-nota nota-fiscal.val-total nota-fiscal.val-liquido fnCod-categoria(nota-fiscal.cod-categoria) @ cCod-categoria fnCod-categoria(nota-fiscal.cd-sub) @ cCd-sub   
...
nota-fiscal.nr-controle                                      column-label "Controle"   
fnCd-favorecido(nota-fiscal.cd-favorecido) @ cCd-favorecido  column-label "Cliente"
nota-fiscal.nr-nota                                          column-label "Nota Fiscal"                               
nota-fiscal.val-total                                        COLUMN-LABEL "Val.Total"
nota-fiscal.val-liquido                                      COLUMN-LABEL "Val. Liquido"
fnCod-categoria(nota-fiscal.cod-categoria) @ cCod-categoria  COLUMN-LABEL "Categoria"   
fnCod-categoria(nota-fiscal.cd-sub) @ cCd-sub                COLUMN-LABEL "Sub-Categoria"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
ON END-ERROR OF C-Win /* Zoom de Notas Fiscais */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Zoom de Notas Fiscais */
DO:
...
DO: 
    {func\zoom\bt_implantar.i &Programa="fav"}
END.
