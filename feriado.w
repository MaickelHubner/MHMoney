...
&GLOBAL-DEFINE Filho         feriado
&GLOBAL-DEFINE LabelFilho    Feriados
&GLOBAL-DEFINE ParentFields  ano
&GLOBAL-DEFINE KeyFields     ano
&GLOBAL-DEFINE CamposFilho   feriado.dt-feriado ~
                             feriado.ds-feriado
...
&Scoped-define QUERY-STRING-br-page1 FOR EACH {&Filho}     WHERE YEAR({&Filho}.dt-feriado) = ano NO-LOCK INDEXED-REPOSITION. RUN controlButtons IN THIS-PROCEDURE
&Scoped-define OPEN-QUERY-br-page1 OPEN QUERY {&SELF-NAME} FOR EACH {&Filho}     WHERE YEAR({&Filho}.dt-feriado) = ano NO-LOCK INDEXED-REPOSITION. RUN controlButtons IN THIS-PROCEDURE.
...
&Scoped-Define ENABLED-OBJECTS br-page1 ano btAdd-page1 btDel-page1 btExit ~
btFirst btLast btNext btPrev btUpdate-page1 btGoTo btZoom RECT-5 RECT-6 
&Scoped-Define DISPLAYED-OBJECTS ano 
...
OPEN QUERY {&SELF-NAME} FOR EACH {&Filho}
    WHERE YEAR({&Filho}.dt-feriado) = ano NO-LOCK INDEXED-REPOSITION.
...
DO:
    ASSIGN iAnoFer = INPUT FRAME {&FRAME-NAME} ano.
    {func\bt_add_page.i}
END.
...
DISPLAY ano WITH FRAME {&FRAME-NAME}.

{func\master_detail\display.i}

ENABLE btPrev
       btNext WITH FRAME {&FRAME-NAME}.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE br-page1 ano btAdd-page1 btDel-page1 btExit btFirst btLast btNext 
         btPrev btUpdate-page1 btGoTo btZoom RECT-5 RECT-6 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
