...
&GLOBAL-DEFINE Filho         tabela-preco-item
&GLOBAL-DEFINE LabelFilho    Itens
&GLOBAL-DEFINE ParentFields  tabela-preco.cd-tabela tabela-preco.ds-tabela
&GLOBAL-DEFINE KeyFields     tabela-preco.cd-tabela
&GLOBAL-DEFINE CamposFilho   fnCd-item(tabela-preco-item.cd-item) @ cCd-item ~
...
&Scoped-define INTERNAL-TABLES {&Filho} tabela-preco
...
DEFINE FRAME DEFAULT-FRAME
     ...
     tabela-preco.cd-tabela-preco AT ROW 4.5 COL 22 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 4 BY .79
     tabela-preco.ds-tabela-preco AT ROW 4.5 COL 26 COLON-ALIGNED NO-LABEL WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 49 BY .79
...
IF NOT AVAIL {&Table} THEN DO:
    ...
    ASSIGN tabela-preco.cd-tabela:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ?
           tabela-preco.ds-tabela:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "".
...
------------------------------------------------------------------------------*/
  ...
  ENABLE br-page1 btAdd-page1 btDel-page1 btExit btFirst btLast btNext btPrev 
         btUpdate-page1 btGoTo btZoom tabela-preco.cd-tabela-preco 
         tabela-preco.ds-tabela-preco RECT-5 RECT-6 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
IF CAN-FIND(FIRST pedido-item OF tabela-preco-item) THEN DO:
    {func\valida.i &Mensagem  = "Eliminaá∆o n∆o permitida!"
                   &Ajuda     = "J† existe item de pedido relacionado Ö esse item da tabela de preáo."}
END.
