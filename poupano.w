...
&GLOBAL-DEFINE Filho         item-poupanca
&GLOBAL-DEFINE LabelFilho    Valor Anual
&GLOBAL-DEFINE ParentFields  poupanca.cd-poupanca poupanca.ds-poupanca
&GLOBAL-DEFINE KeyFields     poupanca.cd-poupanca
&GLOBAL-DEFINE CamposFilho   item-poupanca.ano ~
                             item-poupanca.pc-juros ~
                             item-poupanca.vl-deposito ~
                             item-poupanca.vl-espontaneo
...
&Scoped-define INTERNAL-TABLES {&Filho} poupanca
...
&Scoped-define FIELDS-IN-QUERY-DEFAULT-FRAME poupanca.cd-poupanca ~
poupanca.ds-poupanca 
&Scoped-define ENABLED-FIELDS-IN-QUERY-DEFAULT-FRAME poupanca.cd-poupanca ~
poupanca.ds-poupanca 
...
DEFINE FRAME DEFAULT-FRAME
     ...
     poupanca.cd-poupanca AT ROW 4.5 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY .79
     poupanca.ds-poupanca AT ROW 4.5 COL 26.29 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 49 BY .79
...
IF NOT AVAIL {&Table} THEN DO:
    ...
    ASSIGN poupanca.cd-poupanca:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ?
           poupanca.ds-poupanca:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "".
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE poupanca THEN 
    DISPLAY poupanca.cd-poupanca poupanca.ds-poupanca 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE br-page1 btAdd-page1 btDel-page1 btExit btFirst btLast btNext btPrev 
         btUpdate-page1 poupanca.cd-poupanca poupanca.ds-poupanca btGoTo btZoom 
         RECT-5 RECT-6 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN whColuna = BROWSE br-page1:GET-BROWSE-COLUMN(4)
         whColuna:LABEL = "Janeiro"
         whColuna = BROWSE br-page1:GET-BROWSE-COLUMN(5)
         whColuna:LABEL = "Fevereiro"
         whColuna = BROWSE br-page1:GET-BROWSE-COLUMN(6)
         whColuna:LABEL = "Maráo"
         whColuna = BROWSE br-page1:GET-BROWSE-COLUMN(7)
         whColuna:LABEL = "Abril"
         whColuna = BROWSE br-page1:GET-BROWSE-COLUMN(8)
         whColuna:LABEL = "Maio"
         whColuna = BROWSE br-page1:GET-BROWSE-COLUMN(9)
         whColuna:LABEL = "Junho"
         whColuna = BROWSE br-page1:GET-BROWSE-COLUMN(10)
         whColuna:LABEL = "Julho"
         whColuna = BROWSE br-page1:GET-BROWSE-COLUMN(11)
         whColuna:LABEL = "Agosto"
         whColuna = BROWSE br-page1:GET-BROWSE-COLUMN(12)
         whColuna:LABEL = "Setembro"
         whColuna = BROWSE br-page1:GET-BROWSE-COLUMN(13)
         whColuna:LABEL = "Outubro"
         whColuna = BROWSE br-page1:GET-BROWSE-COLUMN(14)
         whColuna:LABEL = "Novembro"
         whColuna = BROWSE br-page1:GET-BROWSE-COLUMN(15)
         whColuna:LABEL = "Dezembro".
