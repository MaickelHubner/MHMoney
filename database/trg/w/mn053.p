TRIGGER PROCEDURE FOR WRITE OF contato-caracteristica NEW BUFFER newTab OLD BUFFER oldTab.
...
FUNCTION fnValor RETURNS CHARACTER (cTab AS CHARACTER, cCampo AS CHARACTER):
    ...
    CASE cTab:
        WHEN "NEW" THEN DO:
            CASE cCampo:
                WHEN "cd-caracteristica" THEN DO:
                    ASSIGN cValor = TRIM(STRING(newTab.cd-caracteristica,"9999")).
                END.
                ...
                WHEN "descricao" THEN DO:
                    ASSIGN cValor = TRIM(STRING(newTab.descricao,"x(80)")).
                END.
        ...
        WHEN "OLD" THEN DO:
            CASE cCampo:
                WHEN "cd-caracteristica" THEN DO:
                    ASSIGN cValor = TRIM(STRING(oldTab.cd-caracteristica,"9999")).
                END.
                WHEN "cd-contato" THEN DO:
                ...
                END.
                WHEN "descricao" THEN DO:
                    ASSIGN cValor = TRIM(STRING(oldTab.descricao,"x(80)")).
                END.
                WHEN "sequencia" THEN DO:
...
IF param-mn.sincroniza THEN DO:
    ...
    OR LOOKUP("cd-contato",cResult) <> 0
