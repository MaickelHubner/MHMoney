TRIGGER PROCEDURE FOR WRITE OF tabela-preco NEW BUFFER newTab OLD BUFFER oldTab.
    ...
    CASE cTab:
        WHEN "NEW" THEN DO:
            CASE cCampo:
                ...
                END.
                WHEN "ds-tabela-preco" THEN DO:
                    ASSIGN cValor = TRIM(STRING(newTab.ds-tabela-preco,"X(40)")).
                END.
        ...
        WHEN "OLD" THEN DO:
            CASE cCampo:
                ...
                END.
                WHEN "ds-tabela-preco" THEN DO:
                    ASSIGN cValor = TRIM(STRING(oldTab.ds-tabela-preco,"X(40)")).
                END.
                WHEN "dt-val-fim" THEN DO:
...
IF param-mn.sincroniza THEN DO:
    ...
    IF LOOKUP("cd-tabela-preco",cResult) <> 0 THEN DO:
