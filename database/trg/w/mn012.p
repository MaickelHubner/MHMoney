TRIGGER PROCEDURE FOR WRITE OF usuario-prog NEW BUFFER newTab OLD BUFFER oldTab.
    ...
    CASE cTab:
        WHEN "NEW" THEN DO:
            CASE cCampo:
                ...
                END.
                WHEN "programa" THEN DO:
                    ASSIGN cValor = TRIM(STRING(newTab.programa,"X(40)")).
                END.
            END CASE.
        END.
        WHEN "OLD" THEN DO:
            CASE cCampo:
                ...
                END.
                WHEN "programa" THEN DO:
                    ASSIGN cValor = TRIM(STRING(oldTab.programa,"X(40)")).
                END.
            END CASE.
        END.
    END CASE.
...
IF param-mn.sincroniza THEN DO:
    ...
    OR LOOKUP("programa",cResult) <> 0 THEN DO:
        ...
        CREATE lote-mov-campo.
        ASSIGN lote-mov-campo.num-mov = iNum
               lote-mov-campo.campo   = "programa"
               lote-mov-campo.chave   = YES
               lote-mov-campo.origem  = param-mn.maquina-local
               lote-mov-campo.antes   = TRIM(STRING(newTab.programa,"X(40)")).
    ...
    ELSE DO:
        ...
        ASSIGN lote-mov-campo.num-mov = iNum
               ...
               lote-mov-campo.chave   = YES
               lote-mov-campo.origem  = param-mn.maquina-local
               lote-mov-campo.antes   = TRIM(STRING(oldTab.programa,"X(40)")).
               lote-mov-campo.depois  = TRIM(STRING(newTab.programa,"X(40)")).
