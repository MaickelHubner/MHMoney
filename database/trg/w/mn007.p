        ...
        WHEN "NEW" THEN DO:
            CASE cCampo:
                WHEN "calc-ir" THEN DO:
                    ASSIGN cValor = TRIM(STRING(newTab.calc-ir,"Sim/NÆo")).
                END.
                ...
                WHEN "simulacao" THEN DO:
                    ASSIGN cValor = TRIM(STRING(newTab.simulacao,"Sim/NÆo")).
                END.
            END CASE.
        END.
        WHEN "OLD" THEN DO:
            CASE cCampo:
                WHEN "calc-ir" THEN DO:
                    ASSIGN cValor = TRIM(STRING(oldTab.calc-ir,"Sim/NÆo")).
                END.
                WHEN "cd-conta" THEN DO:
                ...
                END.
                WHEN "simulacao" THEN DO:
                    ASSIGN cValor = TRIM(STRING(oldTab.simulacao,"Sim/NÆo")).
                END.
            END CASE.
        END.
    END CASE.
