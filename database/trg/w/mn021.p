TRIGGER PROCEDURE FOR WRITE OF projeto NEW BUFFER newTab OLD BUFFER oldTab.
    ...
    CASE cTab:
        WHEN "NEW" THEN DO:
            CASE cCampo:
                ...
                END.
                WHEN "ds-projeto" THEN DO:
                    ASSIGN cValor = TRIM(STRING(newTab.ds-projeto,"X(40)")).
                END.
            END CASE.
        END.
        WHEN "OLD" THEN DO:
            CASE cCampo:
                ...
                END.
                WHEN "ds-projeto" THEN DO:
                    ASSIGN cValor = TRIM(STRING(oldTab.ds-projeto,"X(40)")).
                END.
            END CASE.
        END.
    END CASE.
...
IF param-mn.sincroniza THEN DO:
    ...
    IF LOOKUP("cd-projeto",cResult) <> 0 THEN DO:
