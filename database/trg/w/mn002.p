TRIGGER PROCEDURE FOR WRITE OF categoria NEW BUFFER newTab OLD BUFFER oldTab.
    ...
    CASE cTab:
        WHEN "NEW" THEN DO:
            CASE cCampo:
                ...
                END.
                WHEN "ds-categoria" THEN DO:
                    ASSIGN cValor = TRIM(STRING(newTab.ds-categoria,"X(40)")).
                END.
        ...
        WHEN "OLD" THEN DO:
            CASE cCampo:
                ...
                END.
                WHEN "ds-categoria" THEN DO:
                    ASSIGN cValor = TRIM(STRING(oldTab.ds-categoria,"X(40)")).
                END.
                WHEN "id-tipo" THEN DO:
...
IF param-mn.sincroniza THEN DO:
    ...
    IF LOOKUP("cod-categoria",cResult) <> 0 THEN DO:
