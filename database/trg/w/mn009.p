TRIGGER PROCEDURE FOR WRITE OF orcamento NEW BUFFER newTab OLD BUFFER oldTab.
    ...
    CASE cTab:
        WHEN "NEW" THEN DO:
            CASE cCampo:
                ...
                END.
                WHEN "ds-orcamento" THEN DO:
                    ASSIGN cValor = TRIM(STRING(newTab.ds-orcamento,"X(40)")).
                END.
            END CASE.
        END.
        WHEN "OLD" THEN DO:
            CASE cCampo:
                ...
                END.
                WHEN "ds-orcamento" THEN DO:
                    ASSIGN cValor = TRIM(STRING(oldTab.ds-orcamento,"X(40)")).
                END.
            END CASE.
        END.
    END CASE.
...
IF param-mn.sincroniza THEN DO:
    ...
    IF LOOKUP("cd-orcamento",cResult) <> 0 THEN DO:
