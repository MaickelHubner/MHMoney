TRIGGER PROCEDURE FOR WRITE OF tabela-ir NEW BUFFER newTab OLD BUFFER oldTab.
    ...
    CASE cTab:
        WHEN "NEW" THEN DO:
            CASE cCampo:
                ...
                END.
                WHEN "ds-tabela" THEN DO:
                    ASSIGN cValor = TRIM(STRING(newTab.ds-tabela,"X(40)")).
                END.
                WHEN "dt-end" THEN DO:
                ...
                END.
                WHEN "max-educacao" THEN DO:
                    ASSIGN cValor = TRIM(STRING(newTab.max-educacao,"->>,>>9.99")).
                END.
                WHEN "max-simp" THEN DO:
                    ASSIGN cValor = TRIM(STRING(newTab.max-simp,"->>,>>9.99")).
                END.
                WHEN "pc-simp" THEN DO:
                    ASSIGN cValor = TRIM(STRING(newTab.pc-simp,"->>,>>9.99")).
                END.
                WHEN "val-dependente" THEN DO:
                    ASSIGN cValor = TRIM(STRING(newTab.val-dependente,"->>,>>9.99")).
                END.
            END CASE.
        END.
        WHEN "OLD" THEN DO:
            CASE cCampo:
                ...
                END.
                WHEN "ds-tabela" THEN DO:
                    ASSIGN cValor = TRIM(STRING(oldTab.ds-tabela,"X(40)")).
                END.
                WHEN "dt-end" THEN DO:
                ...
                END.
                WHEN "max-educacao" THEN DO:
                    ASSIGN cValor = TRIM(STRING(oldTab.max-educacao,"->>,>>9.99")).
                END.
                WHEN "max-simp" THEN DO:
                    ASSIGN cValor = TRIM(STRING(oldTab.max-simp,"->>,>>9.99")).
                END.
                WHEN "pc-simp" THEN DO:
                    ASSIGN cValor = TRIM(STRING(oldTab.pc-simp,"->>,>>9.99")).
                END.
                WHEN "val-dependente" THEN DO:
                    ASSIGN cValor = TRIM(STRING(oldTab.val-dependente,"->>,>>9.99")).
                END.
            END CASE.
        END.
    END CASE.
...
IF param-mn.sincroniza THEN DO:
    ...
    IF LOOKUP("cd-tabela",cResult) <> 0 THEN DO:
