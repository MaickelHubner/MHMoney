    ...
    CASE cTab:
        WHEN "NEW" THEN DO:
            CASE cCampo:
                ...
                WHEN "compromisso" THEN DO:
                    ASSIGN cValor = TRIM(STRING(newTab.compromisso,"Sim/NÆo")).
                END.
                ...
                WHEN "ocupado" THEN DO:
                    ASSIGN cValor = TRIM(STRING(newTab.ocupado,"Sim/NÆo")).
                END.
        ...
        WHEN "OLD" THEN DO:
            CASE cCampo:
                ...
                END.
                WHEN "compromisso" THEN DO:
                    ASSIGN cValor = TRIM(STRING(oldTab.compromisso,"Sim/NÆo")).
                END.
                WHEN "ds-observacao" THEN DO:
                ...
                END.
                WHEN "ocupado" THEN DO:
                    ASSIGN cValor = TRIM(STRING(oldTab.ocupado,"Sim/NÆo")).
                END.
                WHEN "qt-visita" THEN DO:
