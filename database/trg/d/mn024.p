TRIGGER PROCEDURE FOR DELETE OF proj-periodo-nivel.
...
IF param-mn.sincroniza THEN DO:
    ...
    ASSIGN lote-mov.usuario  = gcUsuario
           ...
           lote-mov.tabela   = "proj-periodo-nivel"
    ...
    ASSIGN lote-mov-campo.num-mov = iNum
           ...
           lote-mov-campo.antes   = TRIM(STRING(proj-periodo-nivel.cd-projeto,"999")).
    ...
    ASSIGN lote-mov-campo.num-mov = iNum
           ...
           lote-mov-campo.chave   = yes
           lote-mov-campo.origem  = param-mn.maquina-local
           lote-mov-campo.antes   = TRIM(STRING(proj-periodo-nivel.cd-periodo,"999")).
    ...
    ASSIGN lote-mov-campo.num-mov = iNum
           ...
           lote-mov-campo.chave   = yes
           lote-mov-campo.origem  = param-mn.maquina-local
           lote-mov-campo.antes   = TRIM(STRING(proj-periodo-nivel.cd-nivel,">>9")).
