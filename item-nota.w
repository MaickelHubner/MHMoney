...
&GLOBAL-DEFINE Filho         nota-fiscal-item
...
&GLOBAL-DEFINE CamposFilho   nota-fiscal-item.sequencia ~
                             fnCd-item(nota-fiscal-item.cd-item) @ cCd-item ~
                             nota-fiscal-item.val-unitario ~
                             nota-fiscal-item.quantidade ~
...
DO:
    ...
    FOR EACH nota-fiscal-item OF nota-fiscal NO-LOCK:
        ASSIGN nota-fiscal.val-itens = nota-fiscal.val-itens + nota-fiscal-item.val-total.
    END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE br-page1 btAdd-page1 btDel-page1 btExit btFirst btLast btNext btPrev 
         btUpdate-page1 btGoTo btZoom nota-fiscal.nr-controle 
         nota-fiscal.cd-favorecido nota-fiscal.dt-emissao nota-fiscal.val-total 
