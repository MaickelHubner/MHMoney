...
DEFINE OUTPUT PARAMETER deOut AS DECIMAL      NO-UNDO.
...
&Scoped-Define ENABLED-OBJECTS btOK valor IMAGE-1 
&Scoped-Define DISPLAYED-OBJECTS valor 
...
DEFINE FRAME DEFAULT-FRAME
     btOK AT ROW 3.5 COL 31
     valor AT ROW 4.25 COL 6 COLON-ALIGNED NO-LABEL
     IMAGE-1 AT ROW 1.25 COL 11
...
DO:
    ...
    ASSIGN deOut = INPUT FRAME {&FRAME-NAME} valor.
...
ON RETURN OF valor IN FRAME DEFAULT-FRAME
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  {version.i valor}
  ASSIGN valor = deIni
         C-Win:TITLE = ENTRY(1,C-Win:TITLE,"-") + "-" + ENTRY(2,C-Win:TITLE,"-") + "- " + cTitulo
         C-Win:TOP-ONLY = YES.
  RUN enable_UI.
