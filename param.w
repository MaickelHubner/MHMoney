...
&Scoped-Define ENABLED-FIELDS param-mn.sincroniza param-mn.conta-recibo ~
param-mn.maquina-local param-mn.maquina-destino param-mn.categoria-recibo ~
param-mn.lote-exp param-mn.lote-imp param-mn.sub-recibo param-mn.email-de ~
param-mn.email-para param-mn.categoria-nf param-mn.serv-email ~
param-mn.porta-email param-mn.sub-nf param-mn.pc-cpmf param-mn.caminho-ie ~
param-mn.cidade param-mn.perc-impto-padrao param-mn.ofc-dir ~
param-mn.conta-desp-viag param-mn.prod-dir param-mn.fav-desp-viag ~
param-mn.caminho-anexos param-mn.conta-desp-nreemb param-mn.imp-etiq 
&Scoped-define ENABLED-TABLES param-mn
&Scoped-define FIRST-ENABLED-TABLE param-mn
&Scoped-Define ENABLED-OBJECTS btCancel RECT-1 RECT-8 RECT-11 RECT-13 ~
RECT-14 ds-conta cat btSave subcat cat-nf subcat-nf ds-conta-desp ~
ds-fav-desp ds-conta-DNR 
&Scoped-Define DISPLAYED-FIELDS param-mn.sincroniza param-mn.conta-recibo ~
param-mn.maquina-local param-mn.maquina-destino param-mn.categoria-recibo ~
param-mn.lote-exp param-mn.lote-imp param-mn.sub-recibo param-mn.email-de ~
param-mn.email-para param-mn.categoria-nf param-mn.serv-email ~
param-mn.porta-email param-mn.sub-nf param-mn.perfil param-mn.pc-cpmf ~
param-mn.caminho-ie param-mn.cidade param-mn.perc-impto-padrao ~
param-mn.ofc-dir param-mn.conta-desp-viag param-mn.prod-dir ~
param-mn.fav-desp-viag param-mn.caminho-anexos param-mn.conta-desp-nreemb ~
param-mn.imp-etiq 
...
ds-conta-desp ds-fav-desp ds-conta-DNR 
...
DEFINE FRAME DEFAULT-FRAME
     btCancel AT ROW 13.92 COL 150.14
     ...
     param-mn.perfil AT ROW 8.25 COL 96 COLON-ALIGNED WIDGET-ID 4
          ...
          DROP-DOWN-LIST
          SIZE 16 BY 1
     param-mn.pc-cpmf AT ROW 8.25 COL 144 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY .79
     param-mn.caminho-ie AT ROW 8.5 COL 7.14
          VIEW-AS FILL-IN 
          SIZE 57 BY .79
     param-mn.cidade AT ROW 9.25 COL 96 COLON-ALIGNED WIDGET-ID 34
          VIEW-AS FILL-IN 
          SIZE 20.57 BY .79
     param-mn.perc-impto-padrao AT ROW 9.25 COL 144 COLON-ALIGNED WIDGET-ID 38
          VIEW-AS FILL-IN 
          SIZE 9 BY .79
     param-mn.ofc-dir AT ROW 9.5 COL 6.86
          VIEW-AS FILL-IN 
          SIZE 57 BY .79
     param-mn.conta-desp-viag AT ROW 10.25 COL 96 COLON-ALIGNED WIDGET-ID 40
          LABEL "Conta Desp Viagem"
          VIEW-AS FILL-IN 
          SIZE 4 BY .79
     ds-conta-desp AT ROW 10.25 COL 100 COLON-ALIGNED NO-LABEL WIDGET-ID 42 NO-TAB-STOP 
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 155.57 BY 14.79
         FONT 1.

/* DEFINE FRAME statement is approaching 4K Bytes.  Breaking it up   */
DEFINE FRAME DEFAULT-FRAME
     param-mn.fav-desp-viag AT ROW 11.25 COL 96 COLON-ALIGNED WIDGET-ID 44
          LABEL "Fav Desp Viagem"
          VIEW-AS FILL-IN 
          SIZE 5 BY .79
     ds-fav-desp AT ROW 11.25 COL 101 COLON-ALIGNED NO-LABEL WIDGET-ID 46 NO-TAB-STOP 
     param-mn.caminho-anexos AT ROW 11.5 COL 5.43 WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 57 BY .79
     param-mn.conta-desp-nreemb AT ROW 12.25 COL 96 COLON-ALIGNED WIDGET-ID 50
          VIEW-AS FILL-IN 
          SIZE 4 BY .79
     ds-conta-DNR AT ROW 12.25 COL 100 COLON-ALIGNED NO-LABEL WIDGET-ID 52 NO-TAB-STOP 
     param-mn.imp-etiq AT ROW 12.5 COL 9.14 WIDGET-ID 48
          VIEW-AS FILL-IN 
          SIZE 57 BY .79
...
------------------------------------------------------------------------------*/
  DISPLAY ds-conta cat subcat cat-nf subcat-nf ds-conta-desp ds-fav-desp 
          ds-conta-DNR 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  IF AVAILABLE param-mn THEN 
    DISPLAY param-mn.sincroniza param-mn.conta-recibo param-mn.maquina-local 
          param-mn.maquina-destino param-mn.categoria-recibo param-mn.lote-exp 
          param-mn.lote-imp param-mn.sub-recibo param-mn.email-de 
          param-mn.email-para param-mn.categoria-nf param-mn.serv-email 
          param-mn.porta-email param-mn.sub-nf param-mn.perfil param-mn.pc-cpmf 
          param-mn.caminho-ie param-mn.cidade param-mn.perc-impto-padrao 
          param-mn.ofc-dir param-mn.conta-desp-viag param-mn.prod-dir 
          param-mn.fav-desp-viag param-mn.caminho-anexos 
          param-mn.conta-desp-nreemb param-mn.imp-etiq 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE btCancel RECT-1 RECT-8 RECT-11 RECT-13 RECT-14 param-mn.sincroniza 
         param-mn.conta-recibo ds-conta param-mn.maquina-local 
         param-mn.maquina-destino param-mn.categoria-recibo cat 
         param-mn.lote-exp param-mn.lote-imp btSave param-mn.sub-recibo subcat 
         param-mn.email-de param-mn.email-para param-mn.categoria-nf cat-nf 
         param-mn.serv-email param-mn.porta-email param-mn.sub-nf subcat-nf 
         param-mn.pc-cpmf param-mn.caminho-ie param-mn.cidade 
         param-mn.perc-impto-padrao param-mn.ofc-dir param-mn.conta-desp-viag 
         ds-conta-desp param-mn.prod-dir param-mn.fav-desp-viag ds-fav-desp 
         param-mn.caminho-anexos param-mn.conta-desp-nreemb ds-conta-DNR 
         param-mn.imp-etiq 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
